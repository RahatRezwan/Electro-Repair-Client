...
const Banner = () => {
   return (
      <div className="h-[700px] relative mb-24">
         <Swiper
            slidesPerView={1}
            spaceBetween={20}
            autoplay={true}
         ...
         >
            ...
            <SwiperSlide className="m-0 p-0 static">
               <div
                  className="w-full mx-auto h-[700px] bg-cover bg-no-repeat bg-center flex justify-center items-center"
                  style={{
               ...
               >
                  <div className="text-center text-white">
                     ...
                     <p className="mt-4 w-[60%] mx-auto text-[20px] font-thin">
                        If you looking for a world class device repair service the you are in the
                        right place. I am a certified repairman. I will provide you the best repair
